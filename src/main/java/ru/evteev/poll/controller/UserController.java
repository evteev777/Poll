...
import ru.evteev.poll.mapper.UserMapper;
...
public class UserController {
    ...
    private static final String NO_SUCH_USER = "No such user with ID=%s in database";
    ...
    public UserDTO updateUser(@Valid @RequestBody User user, BindingResult br) {
        throwExceptionIfEmpty(user.getId());
        throwExceptionIfValidationFails(br);
        userService.createOrUpdateUser(user);
        return UserMapper.INSTANCE.toDTO(user);
    }
